...
/**
 * Public constructor.
 * @param {HTMLDocument} doc     The document to parseget.
 * @param {Object}       options The options object.
 */
var Readability = /*#__PURE__*/function () {
  // https =//developer.mozilla.org/en-US/docs/Web/API/Node/nodeTyp
  ...
  function Readability(doc, options) {
    ...
    _defineProperty(this, "FLAG_STRIP_UNLIKELYS", 0x1);

    _defineProperty(this, "FLAG_WEIGHT_CLASSES", 0x2);

    _defineProperty(this, "FLAG_CLEAN_CONDITIONALLY", 0x4);

    _defineProperty(this, "ELEMENT_NODE", 1);

    _defineProperty(this, "TEXT_NODE", 3);

    _defineProperty(this, "DEFAULT_MAX_ELEMS_TO_PARSE", 0);

    _defineProperty(this, "DEFAULT_N_TOP_CANDIDATES", 5);

    _defineProperty(this, "DEFAULT_TAGS_TO_SCORE", "section,h2,h3,h4,h5,h6,p,td,pre".toUpperCase().split(","));

    _defineProperty(this, "DEFAULT_CHAR_THRESHOLD", 500);

    _defineProperty(this, "REGEXPS", {
    ...
    _defineProperty(this, "UNLIKELY_ROLES", ["menu", "menubar", "complementary", "navigation", "alert", "alertdialog", "dialog"]);

    _defineProperty(this, "DIV_TO_P_ELEMS", new Set(["BLOCKQUOTE", "DL", "DIV", "IMG", "OL", "P", "PRE", "TABLE", "UL"]));

    _defineProperty(this, "ALTER_TO_DIV_EXCEPTIONS", ["DIV", "ARTICLE", "SECTION", "P"]);

    _defineProperty(this, "PRESENTATIONAL_ATTRIBUTES", ["align", "background", "bgcolor", "border", "cellpadding", "cellspacing", "frame", "hspace", "rules", "style", "valign", "vspace"]);

    _defineProperty(this, "DEPRECATED_SIZE_ATTRIBUTE_ELEMS", ["TABLE", "TH", "TD", "HR", "PRE"]);

    _defineProperty(this, "PHRASING_ELEMS", [// "CANVAS", "IFRAME", "SVG", "VIDEO",
    ...
    _defineProperty(this, "CLASSES_TO_PRESERVE", ["page"]);

    _defineProperty(this, "HTML_ESCAPE_MAP", {
      "lt": "<",
      "gt": ">",
      "amp": "&",
      "quot": '"',
  ...
  **/
  ...
  _createClass(Readability, [{
    key: "_postProcessContent",
    value: function _postProcessContent(articleContent) {
    ...
    key: "_removeNodes",
    value: function _removeNodes(nodeList, filterFn) {
    ...
    key: "_replaceNodeTags",
    value: function _replaceNodeTags(nodeList, newTagName) {
      // Avoid ever operating on live node lists.
      if (this._docJSDOMParser && nodeList._isLiveNodeList) {
    ...
    key: "_forEachNode",
    value: function _forEachNode(nodeList, fn) {
    ...
    key: "_findNode",
    value: function _findNode(nodeList, fn) {
    ...
    key: "_someNode",
    value: function _someNode(nodeList, fn) {
    ...
    key: "_everyNode",
    value: function _everyNode(nodeList, fn) {
    ...
    key: "_concatNodeLists",
    value: function _concatNodeLists() {
    ...
    key: "_getAllNodesWithTag",
    value: function _getAllNodesWithTag(node, tagNames) {
    ...
    key: "_cleanClasses",
    value: function _cleanClasses(node) {
    ...
    key: "_fixRelativeUris",
    value: function _fixRelativeUris(articleContent) {
    ...
    key: "_simplifyNestedElements",
    value: function _simplifyNestedElements(articleContent) {
    ...
    key: "_getArticleTitle",
    value: function _getArticleTitle() {
      var doc = this._doc;
      var curTitle = "";
      var origTitle = "";
      ...
      curTitle = curTitle.trim().replace(this.REGEXPS.normalize, " "); // Who added this magic? Based on what?
    ...
    key: "_replaceBrs",
    value: function _replaceBrs(elem) {
    ...
    key: "_setNodeTag",
    value: function _setNodeTag(node, tag) {
    ...
    key: "_prepArticle",
    value: function _prepArticle(articleContent) {
    ...
    **/
    ...
    key: "_initializeNode",
    value: function _initializeNode(node) {
      node.readability = {
        "contentScore": 0
      };
    ...
    key: "_removeAndGetNext",
    value: function _removeAndGetNext(node) {
    ...
    key: "_getNextNode",
    value: function _getNextNode(node, ignoreSelfAndKids) {
    ...
    key: "_textSimilarity",
    value: function _textSimilarity(textA, textB) {
    ...
    key: "_checkByline",
    value: function _checkByline(node, matchString) {
    ...
    key: "_getNodeAncestors",
    value: function _getNodeAncestors(node, maxDepth) {
      maxDepth = maxDepth || 0;
      var i = 0,
          ancestors = [];
    ...
    **/
    ...
    key: "_grabArticle",
    value: function _grabArticle(page) {
    ...
    key: "_isValidByline",
    value: function _isValidByline(byline) {
    ...
    key: "_unescapeHtmlEntities",
    value: function _unescapeHtmlEntities(str) {
      if (!str) {
        return str;
      }
    ...
    key: "_getArticleMetadata",
    value: function _getArticleMetadata(jsonld) {
      var metadata = {};
      var values = {};
    ...
    **/
    ...
    key: "_isSingleImage",
    value: function _isSingleImage(node) {
      if (node.tagName === "IMG") {
        return true;
      }
    ...
    **/
    ...
    key: "_unwrapNoscriptImages",
    value: function _unwrapNoscriptImages(doc) {
    ...
    **/
    ...
    key: "_removeScripts",
    value: function _removeScripts(doc) {
    ...
    **/
    ...
    key: "_hasSingleTagInsideElement",
    value: function _hasSingleTagInsideElement(element, tag) {
    ...
    key: "_isElementWithoutContent",
    value: function _isElementWithoutContent(node) {
    ...
    key: "_hasChildBlockElement",
    value: function _hasChildBlockElement(element) {
      return this._someNode(element.childNodes, function (node) {
    ...
    **/
    ...
    key: "_isPhrasingContent",
    value: function _isPhrasingContent(node) {
    ...
    key: "_isWhitespace",
    value: function _isWhitespace(node) {
    ...
    **/
    ...
    key: "_getInnerText",
    value: function _getInnerText(e, normalizeSpaces) {
    ...
    **/
    ...
    key: "_getCharCount",
    value: function _getCharCount(e, s) {
      s = s || ",";
    ...
    **/
    ...
    key: "_getLinkDensity",
    value: function _getLinkDensity(element) {
    ...
    **/
    ...
    key: "_getClassWeight",
    value: function _getClassWeight(e) {
    ...
    key: "_hasAncestorTag",
    value: function _hasAncestorTag(node, tagName, maxDepth, filterFn) {
      maxDepth = maxDepth || 3;
    ...
    key: "_getRowAndColumnCount",
    value: function _getRowAndColumnCount(table) {
      var rows = 0;
      var columns = 0;
    ...
    key: "_markDataTables",
    value: function _markDataTables(root) {
    ...
    key: "_fixLazyImages",
    value: function _fixLazyImages(root) {
    ...
    key: "_getTextDensity",
    value: function _getTextDensity(e, tags) {
      var _this2 = this;
    ...
    key: "_cleanConditionally",
    value: function _cleanConditionally(e, tag) {
    ...
    key: "_cleanMatchedNodes",
    value: function _cleanMatchedNodes(e, filter) {
    ...
    **/
    ...
    key: "_cleanHeaders",
    value: function _cleanHeaders(e) {
    ...
    key: "_headerDuplicatesTitle",
    value: function _headerDuplicatesTitle(node) {
    ...
    key: "_flagIsActive",
    value: function _flagIsActive(flag) {
      return (this._flags & flag) > 0;
    }
  }, {
    key: "_removeFlag",
    value: function _removeFlag(flag) {
      this._flags = this._flags & ~flag;
    }
  }, {
    key: "_isProbablyVisible",
    value: function _isProbablyVisible(node) {
