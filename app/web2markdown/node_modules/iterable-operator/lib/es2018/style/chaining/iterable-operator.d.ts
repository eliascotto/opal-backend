...
export { InvalidArgumentError, RuntimeError } from '../../error';
export declare class IterableOperator<T> extends IterableOperatorBase<T> {
}
export interface IterableOperator<T> extends ChunkOperator<T>, ChunkByOperator<T>, ConcatOperator<T>, DropRightOperator<T>, DropUntilOperator<T>, DropOperator<T>, FilterOperator<T>, FlattenByOperator<T>, FlattenDeepOperator<T>, FlattenOperator<T>, MapOperator<T>, RepeatOperator<T>, SliceOperator<T>, SplitByOperator<T>, SplitOperator<T>, TakeRightOperator<T>, TakeUntilOperator<T>, TakeOperator<T>, TapOperator<T>, TransformOperator<T>, UniqByOperator<T>, UniqOperator<T>, ZipOperator<T>, ChunkByAsyncOperator<T, Iterable<T>>, ConcatAsyncOperator<T, Iterable<T>>, DropUntilAsyncOperator<T, Iterable<T>>, FilterAsyncOperator<T, Iterable<T>>, FlattenByAsync<T, Iterable<T>>, MapAsyncOperator<T, Iterable<T>>, SplitByAsyncOperator<T, Iterable<T>>, TakeUntilAsyncOperator<T, Iterable<T>>, TapAsyncOperator<T, Iterable<T>>, ToAsyncIterableOperator<T>, TransformAsyncOperator<T, Iterable<T>>, UniqByAsyncOperator<T, Iterable<T>>, ZipAsyncOperator<T, Iterable<T>>, ConsumeOperator<T, Iterable<T>>, EachOperator<T>, EveryOperator<T>, FindOperator<T>, FirstOperator<T>, IncludesOperator<T>, MatchOperator<T>, ReduceOperator<T>, SomeOperator<T>, LastOperator<T>, ToArrayOperator<T>, ToSetOperator<T>, EachAsyncOperator<T, Iterable<T>>, EveryAsyncOperator<T, Iterable<T>>, FindAsyncOperator<T, Iterable<T>>, ReduceAsyncOperator<T, Iterable<T>>, SomeAsyncOperator<T, Iterable<T>> {
}
