...
export declare class AsyncIterableOperator<T> extends AsyncIterableOperatorBase<T> {
}
export interface AsyncIterableOperator<T> extends ChunkAsyncOperator<T>, ChunkByAsyncOperator<T, AsyncIterable<T>>, ConcatAsyncOperator<T, AsyncIterable<T>>, DropAsyncOperator<T>, DropRightAsyncOperator<T>, DropUntilAsyncOperator<T, AsyncIterable<T>>, FilterAsyncOperator<T, AsyncIterable<T>>, FlattenAsyncOperator<T>, FlattenByAsync<T, AsyncIterable<T>>, FlattenDeepAsyncOperator<T>, MapAsyncOperator<T, AsyncIterable<T>>, RepeatAsyncOperator<T>, SliceAsyncOperator<T>, SplitAsyncOperator<T>, SplitByAsyncOperator<T, AsyncIterable<T>>, TakeAsyncOperator<T>, TakeRightAsyncOperator<T>, TakeUntilAsyncOperator<T, AsyncIterable<T>>, TapAsyncOperator<T, AsyncIterable<T>>, TransformAsyncOperator<T, AsyncIterable<T>>, UniqAsyncOperator<T>, UniqByAsyncOperator<T, AsyncIterable<T>>, ZipAsyncOperator<T, AsyncIterable<T>>, ConsumeOperator<T, AsyncIterable<T>>, EachAsyncOperator<T, AsyncIterable<T>>, EveryAsyncOperator<T, AsyncIterable<T>>, FindAsyncOperator<T, AsyncIterable<T>>, FirstAsyncOperator<T>, IncludesAsyncOperator<T>, MatchAsyncOperator<T>, ReduceAsyncOperator<T, AsyncIterable<T>>, SomeAsyncOperator<T, AsyncIterable<T>>, LastAsyncOperator<T>, ToArrayAsyncOperator<T>, ToSetAsyncOperator<T> {
}
